...
const MainPage: React.FC = () => {
  ...
  return (
    <div className={[styles.container, styles.noDrag].join(" ")}>
      ...
      <br></br>
      <h1 className={styles.title}>TEAM SS MAFIA</h1>
      <p className={styles.description}>ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ</p>
      <p className={styles.description}>RULES</p>
      <p className={styles.description}>시민 : 6명, 마피아 : 2명으로 구성이고, 각 플레이어는 고유한 직업을 가진다.</p>
      ...
      <p className={styles.description}>ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ</p>
      <button className={styles.button} onClick={startGame}>입장</button>
    </div>
  );
};
